...
#include "relabeling/RDRelabelingStrategy.h"

namespace grf {

RDRelabelingStrategy::RDRelabelingStrategy():
  reduced_form_weight(0) {}

RDRelabelingStrategy::RDRelabelingStrategy(double reduced_form_weight):
  reduced_form_weight(reduced_form_weight) {}

bool RDRelabelingStrategy::relabel(
