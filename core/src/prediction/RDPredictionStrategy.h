...
#ifndef GRF_RDPREDICTIONSTRATEGY_H
#define GRF_RDPREDICTIONSTRATEGY_H
...
// Regression discontinuity forests currently use the same prediction mechanism as instrumental/causal forests.
// We keep this as a separate strategy to allow RD-specific extensions without impacting existing forests.
class RDPredictionStrategy final: public OptimizedPredictionStrategy {
public:
...
#endif //GRF_RDPREDICTIONSTRATEGY_H
