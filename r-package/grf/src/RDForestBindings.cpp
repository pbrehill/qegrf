...
// [[Rcpp::export]]
Rcpp::List rd_train(const Rcpp::NumericMatrix& train_matrix,
                    ...
                    bool legacy_seed,
                    bool verbose) {
  grf::runtime_context.forest_name = "rd";
  grf::runtime_context.verbose_stream = verbose ? &Rcpp::Rcout : nullptr;
  ForestTrainer trainer = rd_trainer(reduced_form_weight, stabilize_splits);
  ...
  data.set_running_index(running_index);
  ...
  if (compute_oob_predictions) {
    ...
    ForestPredictor predictor = rd_predictor(num_threads);
...
// [[Rcpp::export]]
Rcpp::List rd_predict(const Rcpp::List& forest_object,
  ...
  train_data.set_running_index(running_index);
...
// [[Rcpp::export]]
Rcpp::List rd_predict_oob(const Rcpp::List& forest_object,
                          const Rcpp::NumericMatrix& train_matrix,
                          size_t outcome_index,
                          size_t treatment_index,
                          size_t instrument_index,
